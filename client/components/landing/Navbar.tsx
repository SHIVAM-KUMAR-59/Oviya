      ...
      >
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between">
          ...
          <a
            href="#cta"
            {...hoverProps}
            className="navbar-reveal bg-rose border-rose rounded-md hover:bg-rose-lt border px-6 py-2.5 text-[10px] tracking-[0.22em] text-white uppercase transition-all duration-200 hover:-translate-y-px"
          >
            Join Waitlist
          </a>
        </div>
