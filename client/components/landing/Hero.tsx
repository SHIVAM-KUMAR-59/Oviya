...
import { Sparkles, ChevronDown, ArrowRight, Menu, X, Flower2 } from 'lucide-react';
...
const NAV_LINKS = ['Features', 'About', 'Community', 'Blog'];
  ...
  return (
    ...
    >
      ...
      <main
        ref={heroRef}
        id="waitlist"
        className="relative z-10 flex min-h-screen flex-col items-center justify-center px-5 pt-24 pb-20 sm:px-8"
      >
        {/* Badge */}
        <div
