const CTA = ({ hoverProps, ctaForm, setCtaForm, submitForm }: any) => {
  return (
    <section id="cta" className="bg-cream py-28">
      <div className="mx-auto max-w-6xl px-6 md:px-16">
        
        <div className="relative overflow-hidden border border-border-light bg-[radial-gradient(ellipse_70%_60%_at_80%_50%,rgba(107,79,160,0.08),transparent_60%),var(--parchment)] px-10 py-16 md:px-20 md:py-24">
          ...
          <div className="relative z-10 grid items-center gap-16 md:grid-cols-2 md:gap-24">
            ...
            {/* Left */}
            <div>
              <h2 className="mb-5 text-[clamp(44px,4.5vw,68px)] leading-[1.02] tracking-[-0.04em] text-ink font-serif font-light">
                Be first.<br />
                <em className="italic text-mid">Shape</em> what<br />
                comes next.
              </h2>

              <p className="text-[16px] leading-[1.85] text-[#4a3f6b] font-light">
            ...
            <div>
              ...
              >
                <input
                  ...
                  value={ctaForm.val}
                  onChange={(e) =>
                    setCtaForm((f: any) => ({ ...f, val: e.target.value }))
                  }
                  {...hoverProps}
              ...
              {/* Note */}
              <p className="mt-3 text-[10px] uppercase tracking-[0.16em] text-sosoft">
