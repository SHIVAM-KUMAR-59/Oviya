const Footer = () => {
  return (
    <footer className="grid grid-cols-1 items-center gap-4 border-t border-white/5 bg-ink px-6 py-10 text-center md:grid-cols-[1fr_auto_1fr] md:px-16 md:text-left">
